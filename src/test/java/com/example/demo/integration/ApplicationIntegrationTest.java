...
class ApplicationIntegrationTest {
    ...
    void testCalculatorEndpoints() {
        ...
        ResponseEntity<Map<String, Object>> addResponse = restTemplate.exchange(
            baseUrl + "/add?a=5&b=3", HttpMethod.GET, null, new ParameterizedTypeReference<Map<String, Object>>() {});
        assertEquals(HttpStatus.OK, addResponse.getStatusCode());
        assertEquals(8.0, addResponse.getBody().get(RESULT_KEY));
        
        // Test subtraction
        ResponseEntity<Map<String, Object>> subtractResponse = restTemplate.exchange(
            baseUrl + "/subtract?a=10&b=3", HttpMethod.GET, null, new ParameterizedTypeReference<Map<String, Object>>() {});
        assertEquals(HttpStatus.OK, subtractResponse.getStatusCode());
        assertEquals(7.0, subtractResponse.getBody().get(RESULT_KEY));
        
        // Test multiplication
        ResponseEntity<Map<String, Object>> multiplyResponse = restTemplate.exchange(
            baseUrl + "/multiply?a=4&b=3", HttpMethod.GET, null, new ParameterizedTypeReference<Map<String, Object>>() {});
        assertEquals(HttpStatus.OK, multiplyResponse.getStatusCode());
        assertEquals(12.0, multiplyResponse.getBody().get(RESULT_KEY));
        
        // Test division
        ResponseEntity<Map<String, Object>> divideResponse = restTemplate.exchange(
            baseUrl + "/divide?a=15&b=3", HttpMethod.GET, null, new ParameterizedTypeReference<Map<String, Object>>() {});
